    ...
    <Container2>
      ...
      <Main>
        ...
        <Container maxWidth="lg" style={{ marginBottom: '40px' }}>
          ...
          <Paper variant="outlined" style={{ padding: '20px', borderColor: '#8ED197',borderWidth:'2px', height: '36vh',backgroundImage: 'url("https://www.transparenttextures.com/patterns/robots.png")', boxShadow: '0px 0px 100px rgba(0, 0, 0, 0.5)' }}>
